...
const float kTargetHz = 20;

// The number of expected consecutive inferences for each gesture type
extern const int kConsecutiveInferenceThresholds[6];

// Inference result threshold to be considered
const float kMinInferenceThreshold = 0.5;
